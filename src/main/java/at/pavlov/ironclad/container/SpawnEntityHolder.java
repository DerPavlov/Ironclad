...
import at.pavlov.ironclad.Enum.EntityDataType;
...
public class SpawnEntityHolder{
    ...
    public SpawnEntityHolder(String str)
    {
            ...
            if (result.group(4) != null) {
                ...
                for (String s1 : strdata.split(",")){
                    ...
                    if (s2.length > 1){
                        ...
                        if (!found)
                            System.out.println("[Ironclad] " + s2[0] + " is not supported by Ironclad");
                    }
                }
            }
            s.close();
        ...
        {
            System.out.println("[Ironclad] Error while converting " + str + ". Check formating (Zombie 1-2 EntityData)" + e);
            setType(null);
            setMinAmount(0);
            setMaxAmount(0);
        }
